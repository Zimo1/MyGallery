...
import ru.yodata.mygallery.databinding.ActivityPhotoDetailBinding
import ru.yodata.mygallery.presentation.loadImageFull
...
class PhotoDetailActivity : AppCompatActivity(), OnPhotoDetailCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityPhotoDetailBinding = DataBindingUtil.setContentView(this,
        ...
        viewModel.isFavorite.observe(this, Observer {
            it?.let {
                activityPhotoDetailBinding.detailFab
                        .setImageResource(if (it) R.drawable.ic_star_full_vector
